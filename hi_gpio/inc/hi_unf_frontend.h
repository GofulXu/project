...
typedef enum    hiUNF_TUNER_DEV_TYPE_E
{
    ...
    HI_UNF_TUNER_DEV_TYPE_AV2018,				/**<AV2018*/                    /**<CNcomment:支持AV2018射频芯片*/
...
typedef enum hiUNF_TUNER_TS_SYNC_HEAD_E
{
    ...
    HI_UNF_TUNER_TS_SYNC_HEAD_BUTT         	  /**< Invalid value */     /**<CNcomment:非法边界值 */
...
{
    HI_U32                         u32DemodClk;     /**<Demod reference clock frequency, KHz*/    /**<CNcomment:demod参考时钟频率，单位KHz*/
...
{
	HI_U32			u32SCRNo;					/**<user band number of unicable*/              /**<CNcomment:unicable的用户频段号*/
	HI_S32			s32CenterFreq;   			/**<user band frequency of unicable,unit MHz*/  /**<CNcomment:unicable的用户频段中心频率,单位MHz*/
...
/**
\brief Get agc value on wanted frequency.
CNcomment:\brief 获取指定中心频率处的agc值。CNend
\attention \n
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\param[in]  s32CenterFreq      center frequency,unit MHz.   						 CNcomment:中心频率值，单位为MHz。CNend
\param[out] ps32Agc       agc value.        CNcomment:获取到的agc值。CNend
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
\retval ::HI_FAILURE   Calling this API fails.                               CNcomment:API系统调用失败 CNend
\see \n
N/A
*/
HI_S32 HI_UNF_TUNER_GetAgc(HI_U32 u32TunerId,HI_S32 s32CenterFreq, HI_S32 *ps32Agc);
...
/**
\brief  stop user bands scanning.
CNcomment: 终止用户频段扫描。CNend
\attention \n
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
