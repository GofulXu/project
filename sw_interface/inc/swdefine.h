...
#define sw_log_debug( format, ...) 	printf(format,##__VA_ARGS__)
#define sw_log_info( format, ... ) 	printf(format, ##__VA_ARGS__  )
#define sw_log_warn( format, ... ) 	printf(format, ##__VA_ARGS__  )
#define sw_log_error( format, ... ) 	printf(format, ##__VA_ARGS__  )
#define sw_log_fatal( format, ... ) 	printf(format, ##__VA_ARGS__  )
