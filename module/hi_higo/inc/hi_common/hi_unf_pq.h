...
typedef struct hiUNF_PQ_OPT_CHAN_S
{
    ...
    HI_U32       u32Colortemperature;   /**<Color temperature mode; Range:0~3 Disabled、Cold、Middle、Warm */ /**<CNcomment: 色温模式；范围: 0~3 关闭、冷色温、中间色温、暖色温 CNend*/
    HI_U32       u32GammaMode;          /**<Gamma mode; Range:0~4 Disabled、Intension_1.8、Intension_2.5、Curve_Light、Curve_Dark */ /**<CNcomment:伽马模式选择；范围: 0~4 关闭、1.8强度、2.5强度、亮、暗 CNend*/
    HI_U32       u32DynamicContrast;    /**<Color Dynamic Contrast mode; Range:0~3 Disabled、High、Middle、Low */ /**<CNcomment:动态对比度；范围: 0~3 关闭、高、中、低 CNend*/
    HI_U32       u32IntelligentColor;   /**<Color Intelligent Color; Range:0~5 Disabled、Blue、Green、BG、Skin、Vivid */ /**<CNcomment:智能颜色管理；范围: 0~5 关闭、蓝色、绿色、蓝绿增强、肤色、生动 CNend*/    
...
typedef struct hiUNF_PQ_OPT_COMMON_S
{
    ...
    HI_U32       u32Denoise;         /**<Denoise; Range:0~1 Disabled、Auto */ /**<CNcomment:降噪使能；范围:0~1 关闭、自动 CNend*/       
    HI_U32       u32FilmMode;        /**<FileMode; Range:0~1 Disabled、Auto */ /**<CNcomment:电影模式使能选择；范围:0~1 关闭、自动 CNend*/    
