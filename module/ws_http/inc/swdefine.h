...
#define sw_log_debug( format, ...) 	sw_log( LOG_LEVEL_DEBUG, "goefultest", __FILE__, __LINE__, format, ##__VA_ARGS__  )
#define sw_log_info( format, ... ) 	sw_log( LOG_LEVEL_INFO, "goefultest", __FILE__, __LINE__, format, ##__VA_ARGS__  )
#define sw_log_warn( format, ... ) 	sw_log( LOG_LEVEL_WARN, "goefltest", __FILE__, __LINE__, format, ##__VA_ARGS__  )
#define sw_log_error( format, ... ) 	sw_log( LOG_LEVEL_ERROR, "goefultest", __FILE__, __LINE__, format, ##__VA_ARGS__  )
#define sw_log_fatal( format, ... ) 	sw_log( LOG_LEVEL_FATAL, "goefultest", __FILE__, __LINE__, format, ##__VA_ARGS__  )
