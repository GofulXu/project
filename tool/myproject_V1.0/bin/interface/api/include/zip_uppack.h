...
#define ZIPUPPACK_LOG_DEBUG( format, ...) 	gf_log(LOG_LEVEL_DEBUG, "zipuppack", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define ZIPUPPACK_LOG_INFO( format, ...)	 	gf_log(LOG_LEVEL_INFO, "zipuppack", __FUNCTION__, __LINE__, format, ##__VA_ARGS__) 
#define ZIPUPPACK_LOG_WARN( format, ...)		gf_log(LOG_LEVEL_WARN, "zipuppack", __FUNCTION__, __LINE__, format, ##__VA_ARGS__) 
#define ZIPUPPACK_LOG_ERROR( format, ...) 	gf_log(LOG_LEVEL_ERROR, "zipuppack", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define ZIPUPPACK_LOG_FATAL( format, ...) 	gf_log(LOG_LEVEL_FATAL, "zipuppack", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
