...
#define GFTCPSERVER_LOG_DEBUG( format, ...) 	gf_log(LOG_LEVEL_DEBUG, "gftcpserver", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPSERVER_LOG_INFO( format, ...) 	gf_log(LOG_LEVEL_INFO, "gftcpserver", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPSERVER_LOG_WARN( format, ...) 	gf_log(LOG_LEVEL_WARN, "gftcpserver", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPSERVER_LOG_ERROR( format, ...) 	gf_log(LOG_LEVEL_ERROR, "gftcpserver", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPSERVER_LOG_FATAL( format, ...) 	gf_log(LOG_LEVEL_FATAL, "gftcpserver", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
