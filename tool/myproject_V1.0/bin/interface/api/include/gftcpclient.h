...
#define GFTCPCLIENT_LOG_DEBUG( format, ...) 	gf_log(LOG_LEVEL_DEBUG, "gftcpclient", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPCLIENT_LOG_INFO( format, ...) 	gf_log(LOG_LEVEL_INFO, "gftcpclient", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPCLIENT_LOG_WARN( format, ...) 	gf_log(LOG_LEVEL_WARN, "gftcpclient", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPCLIENT_LOG_ERROR( format, ...) 	gf_log(LOG_LEVEL_ERROR, "gftcpclient", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define GFTCPCLIENT_LOG_FATAL( format, ...) 	gf_log(LOG_LEVEL_FATAL, "gftcpclient", __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
