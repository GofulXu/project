...
#define MATERIAL_DIR "/home/goeful/learn/xfyun/api/src/xfyun/bin/material"
...

{
	...
	const char *  lgi_param     = "appid = 5bc6ebc9";
	...
	case read_syllable_cn:
		...
		//f_txt = fopen(MATERIAL_DIR"/ise_cn/cn_syll.txt", "rb+");

		f_txt = fopen(MATERIAL_DIR"/ise_cn/cn_syll2.txt", "rb+");//无拼音标注

		f_pcm = fopen(MATERIAL_DIR"/ise_cn/cn_syll.wav", "rb+");
	...
	case read_word_cn:
		...
		f_txt = fopen(MATERIAL_DIR"/ise_cn/cn_word.txt", "rb+");

		f_pcm = fopen(MATERIAL_DIR"/ise_cn/cn_word.wav", "rb+");
	...
	case read_sentence_cn:
		...
		f_txt = fopen(MATERIAL_DIR"/ise_cn/cn_sentence.txt", "rb+");

		f_pcm = fopen(MATERIAL_DIR"/ise_cn/cn_sentence.wav", "rb+");
	...
	case read_word_en:
		...
		f_txt = fopen(MATERIAL_DIR"/ise_en/en_word.txt", "rb+");

		f_pcm = fopen(MATERIAL_DIR"/ise_en/en_word.wav", "rb+");
	...
	case read_sentence_en:
		...
		f_txt = fopen(MATERIAL_DIR"/ise_en/en_sentence.txt", "rb+");

		f_pcm = fopen(MATERIAL_DIR"/ise_en/en_sentence.wav", "rb+");
