...
HI_S32 main(HI_S32 argc,HI_CHAR **argv)
{
    ...
    ret = HI_GO_FillRect(hLayerSurfaceHD,NULL,0xFF00FF00,HIGO_COMPOPT_NONE);
    if (HI_SUCCESS != ret)
    {
       goto ERR2;
    }
	...
	switch(getchar())
	{
		case 'r': HI_GO_FillRect(hLayerSurfaceHD,NULL,0xFFFF0000,HIGO_COMPOPT_NONE);			\
				  HI_GO_RefreshLayer(hLayerHD, NULL);break;	\
		case 'g': HI_GO_FillRect(hLayerSurfaceHD,NULL,0xFF00FF00,HIGO_COMPOPT_NONE);			\
				  HI_GO_RefreshLayer(hLayerHD, NULL);break;	\
		case 'b': HI_GO_FillRect(hLayerSurfaceHD,NULL,0xFF0000FF,HIGO_COMPOPT_NONE);			\
				  HI_GO_RefreshLayer(hLayerHD, NULL);break;	\
