...

{
	...
	fp = fopen(MATERIAL_DIR"/gm_continuous_digit.abnf", "rb");
...
{	
	...
	const char* login_params			=	"appid = 5bc6ebc9, work_dir = ."; //登录参数,appid与msc库绑定,请勿随意改动
	...
	*/
	...
	printf("上传语法成功\n");
 	...
 	run_asr(MATERIAL_DIR"/wav/iflytek01.wav", session_begin_params, grammar_id); //iflytek01对应的音频内容：“18012345678”
